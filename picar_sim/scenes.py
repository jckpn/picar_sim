from picar_sim.picar_sim import PicarSim
import objects
import numpy as np
...
class Scene5(Scene4):
    def __init__(self, **kwargs):
        ...
        for region in obstacle_regions:
            self.add_random_obstacles(*region)
...
class Scene6(Scene4):
    def __init__(self, **kwargs):
        ...
        self.add_random_obstacles(-58, -75, 44, -37)
        self.add_random_obstacles(-61, 35, 38, 71)
...
class Scene10(PicarSim):
    def __init__(self, controller, controller_interval=0.1, **kwargs):
        super().__init__(
            picar=objects.Picar(
                controller, controller_interval, center=(-50, -10), direction=90
            ),
            track=objects.tracks.Junction(),
            **kwargs,
        )
